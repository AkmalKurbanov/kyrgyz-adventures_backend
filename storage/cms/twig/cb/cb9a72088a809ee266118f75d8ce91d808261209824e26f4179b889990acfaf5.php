...
class __TwigTemplate_4378df4ed76f6f1a20da36a390675241f6b386e34cf94493350dff7e1d0a5de0 extends \Twig\Template
{
  ...
  <div class=\"widget latest-post-widget\">
    <div class=\"widget-title\">
      <h4>";
        // line 12
        echo call_user_func_array($this->env->getFilter('_')->getCallable(), ["Последние посты"]);
        echo "</h4>
    </div>
    ";
        // line 14
  ...
  <div class=\"widget widget_categories\">
    <h4 class=\"widget-title\">";
        // line 27
        echo call_user_func_array($this->env->getFilter('_')->getCallable(), ["Категории"]);
        echo "</h4>
    <ul class=\"cat-menu\">
      ";
        // line 29
...
($context["blogCategories"] ?? null) . "::items")            , $context['__cms_partial_params']            , true            );
  ...
  <!-- <div class=\"widget\">
    ...
    {
        return array (  145 => 39,  141 => 37,  137 => 35,  134 => 31,  132 => 33,  130 => 32,  128 => 31,  125 => 30,  123 => 29,  118 => 27,  114 => 25,  100 => 21,  93 => 19,  89 => 17,  85 => 16,  82 => 15,  80 => 14,  75 => 12,  62 => 1,);
    }
  ...
  <div class=\"widget latest-post-widget\">
    ...
    <div class=\"latest-item\">
      <div class=\"content-part\">
        ...
        <span class=\"text\">{{ post.published_at | date('d') }} {{ post.published_at | rudate('%BP') }} {{ post.published_at | date('Y') }}</span>
      </div>
    </div>
    {% endfor %}
  </div>
  <div class=\"widget widget_categories\">
    <h4 class=\"widget-title\">{{'Категории'|_}}</h4>
    <ul class=\"cat-menu\">
