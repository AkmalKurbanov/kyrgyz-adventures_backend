...
/* C:\work\OSPanel\domains\tabylga/themes/tabylga/pages/summer-tours.htm */
class __TwigTemplate_09f020aafad029009614fe080d7e6e89d4033b70b0613ef95c365d661a756a1a extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["record"]) {
            // line 12
            echo "        ";
            if (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["record"], "category", [], "any", false, false, true, 12), "name", [], "any", false, false, true, 12) == "Summer tours") || (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["record"], "category", [], "any", false, false, true, 12), "name", [], "any", false, false, true, 12) == "Летние туры"))) {
                // line 13
...
($context["activeLocale"] ?? null) == "de")) {
              ...
              <div class=\"btn-wrapper\">
                  ...
                  <a href=\"";
                // line 51
                echo ((twig_get_attribute($this->env, $this->source, ($context["records"] ?? null), "property", [0 => "recordPage"], "method", false, false, true, 51)) ? ($this->extensions['Cms\Twig\Extension']->pageFilter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["records"] ?? null), "property", [0 => "recordPage"], "method", false, false, true, 51), 51, $this->source), [twig_get_attribute($this->env, $this->source, ($context["records"] ?? null), "paramName", [0 => "recordPageSlug"], "method", false, false, true, 51) => twig_get_attribute($this->env, $this->source, $context["record"], "slug", [], "any", false, false, true, 51)])) : (""));
                echo "\">";
    ...
    {
        return "C:\\work\\OSPanel\\domains\\tabylga/themes/tabylga/pages/summer-tours.htm";
    }
    ...
    {
        return array (  198 => 62,  192 => 61,  189 => 60,  175 => 51,  167 => 46,  163 => 45,  158 => 43,  153 => 40,  147 => 38,  141 => 36,  139 => 35,  134 => 34,  132 => 33,  126 => 30,  117 => 23,  109 => 22,  107 => 21,  100 => 20,  98 => 19,  93 => 17,  87 => 13,  84 => 12,  80 => 11,  72 => 6,  68 => 5,  62 => 1,);
    }
  ...
  <div class=\"container\">
    ...
    <div class=\"row\">
      {% for record in records.items %}
        {% if record.category.name == 'Summer tours' or record.category.name == 'Летние туры' %}
...
</div>", "C:\\work\\OSPanel\\domains\\tabylga/themes/tabylga/pages/summer-tours.htm", "");
    }
}
